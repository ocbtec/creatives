      ...
      <div className='terms-container'>
        <div className='terms-container-left'>
          ...
          <p className='terms-p'>
            ...
            conditions in full. Do not continue to use Creatives's website if
          ...
          <p className='terms-p'>
            We employ the use of cookies. By using Creatives's website you
            consent to the use of cookies in accordance with Creatives's privacy
            ...
            advertising partners may also use cookies. License Unless otherwise
            stated, Creatives and/or it's licensors own the intellectual
            property rights for all material on Creatives. All intellectual
            property rights are reserved. You may view and/or print pages from
            http://creatives.org for your own personal use subject to
            restrictions set in these terms and conditions. You must not:
            Republish material from http://creatives.org Sell, rent or
            sub-license material from http://creatives.org Reproduce, duplicate
            or copy material from http://creatives.org Redistribute content from
            Creatives (unless content is specifically made for redistribution).
          </p>
          ...
          <p className='terms-p'>
            ...
            the website. Creatives does not screen, edit, publish or review
            Comments prior to their appearance on the website and Comments do
            not reflect the views or opinions ofCreatives, its agents or
            ...
            laws Creatives shall not be responsible or liable for the Comments
            ...
            appearance of the Comments on this website. Creatives reserves the
            ...
            or otherwise in breach of these Terms and Conditions. You warrant
          ...
          <p className='terms-p'>
            ...
            unlawful activity. You hereby grant to Creatives a non-exclusive
            ...
            formats or media. Hyperlinking to our Content The following
          ...
          <div className='terms-p'>
            <ul style={{ listStyle: 'none' }}>
              ...
              <li>
                (b) does not falsely i'mply sponsorship, endorsement or approval
          ...
          <p className='terms-p'>
            ...
            whose primary clients are businesses; and educational institutions
          ...
          <div className='terms-p'>
            <ul style={{ marginLeft: '20px' }}>
              ...
              <li>
                (b)the organization does not have an unsatisfactory record with
                us
              </li>
              <li>
                (c) the benefit to us from the visibility associated with the
                hyperlink outweighs the absence of Creatives and
              </li>
              <li>
          ...
          <p className='terms-p'>
            ...
            sending an e-mail to info@creatives.org. Please include your name,
            ...
            weeks for a response. Approved organizations may hyperlink to our
            Web site as follows:
          </p>
          <p className='terms-p'>
            ...
            sense within the context and format of content on the linking
            party's site. No use of Creatives's logo or other artwork will be
            ...
            site. Reservation of Rights We reserve the right at any time and in
            its sole discretion to request that you remove all links or any
            particular link to our Web site.
          </p>
          <p className='terms-p'>
            ...
            any link on our Web site or any linked web site objectionable for
            any reason, you may contact us about this. We will consider requests
            to remove links but will have no obligation to do so or to respond
            directly to you. Whilst we endeavour to ensure that the information
          ...
          <p className='terms-p'>
            ...
            third party rights. Disclaimer To the maximum extent permitted by
            ...
            respect of satisfactory quality, fitness for purpose and/or the use
            of reasonable care and skill). Nothing in this disclaimer will:
          ...
          <div className='terms-p'>
            <ul style={{ marginLeft: '20px' }}>
              ...
              <li>
                (b) govern all liabilities arising under the disclaimer or in
          ...
          <p className='terms-p'>
            ...
            any loss or damage of any nature. Credit &amp; Contact Information
